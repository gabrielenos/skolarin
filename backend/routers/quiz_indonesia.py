"""
Router untuk Indonesia Language Guess The Word Quiz
"""
from fastapi import APIRouter, HTTPException, Query
from pydantic import BaseModel
from typing import Optional, Literal
from data.indonesia_guess import INDONESIA_QUESTIONS

router = APIRouter(prefix="/quiz/indonesia", tags=["indonesia_quiz"])
...
def get_questions(level: int = Query(1, ge=1, le=TOTAL_LEVELS)):
    ...
    total_unique_questions = len(INDONESIA_QUESTIONS)  # 50 soal
    ...
    for i in range(QUESTIONS_PER_LEVEL):
        ...
        level_questions.append(INDONESIA_QUESTIONS[index])
...
def get_total_levels():
    ...
    return {
        ...
        "total_questions": len(INDONESIA_QUESTIONS)
    }
