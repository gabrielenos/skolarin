...
router = APIRouter(prefix="/quiz/mathematics", tags=["mathematics_quiz"])
...
@router.get("/scramble")
def get_scramble_questions(level: int = Query(1, ge=1, le=TOTAL_LEVELS)):
    """Mengambil 10 soal scramble untuk level tertentu (dari 50 soal yang di-recycle)"""
...
@router.post("/scramble-check", response_model=CheckAnswerResponse)
