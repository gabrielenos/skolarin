...
export default function MultimatchIndonesiaPage() {
  ...
  // Indonesia-1: 1 level, Indonesia-2 to Indonesia-30: 3 levels each
                    ...
                    {Array.from({ length: level.levelCount }, (_, i) => {
                      ...
                      return (
                        <button
                          ...
                          onClick={() =>
                            !isLocked &&
                            router.push(`/multimatch/multimatch_indonesia/quiz?level=${levelNum}`)
                          }
                          disabled={isLocked}
...
function MultimatchIndonesiaCard({ 
  title, 
  questions, 
  isExpanded 
}: { 
